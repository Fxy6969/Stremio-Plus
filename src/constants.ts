...
export const STORAGE_KEYS = {
    ...
    DISCORD_PRIVACY_MODE: 'discordPrivacyMode',
    DISCORD_SHOW_TIMESTAMPS: 'discordShowTimestamps',
    DISCORD_SHOW_POSTER: 'discordShowPoster',
...
export const IPC_CHANNELS = {
    ...
    UNAPPLY_THEME:        'unapply-theme',
    GET_APPLIED_THEME:    'get-applied-theme',
    THEME_APPLIED:        'theme-applied',          // main→renderer push event
    ...
    // MPV playback backend (NEW — ported from Rust player_backend.rs)
...
export const ENHANCED_PLUGINS_API = {
    ...
    GET_SETTINGS_SYNC: 'get-plugin-settings-sync',
